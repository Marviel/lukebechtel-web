...
GPT-4 was released on Tuesday, and on my sector of Twitter, many of the smartest people I know people were losing their brilliant minds.
<br/>
...
However, to my knowledge, none of these agents have ever been asked to make their *own* programming language.<sup>1</sup> This type of task is a bit more complex, and requires a bit more creativity and foresight than much of the internet believes LLMs to have.

<sub>1. *EDIT: as pointed out by an HN poster, [some prior art does exist](https://judehunter.dev/blog/chatgpt-helped-me-design-a-brand-new-programming-language)*, though nothing yet for GPT-4 (that I can tell).</sub>
<br/>
<br/>

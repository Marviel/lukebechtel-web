...
This morning, I pondered if there might exist a useful analogue between a large language model's (LLM) context window and the human brain. I'll briefly summarize some key concepts in LLMs, and then use that to draw my analogy.

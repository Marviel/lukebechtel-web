---
title: "Aristotle's Rhetoric, Strunkified"
author: 'Aristotle (adapted by Gemini 3 Pro)'
date: '2026-01-03'
tags: ['rhetoric', 'writing', 'philosophy', 'classics']
draft: false
summary: "Aristotle's Rhetoric, condensed and stylized in the spirit of Strunk & White."
---

# Rhetoric

_By Aristotle — Stylized and condensed in the manner of Strunk & White_

_Presented without commentary, save the following Editor's Note:_

_I constructed this (with LLM assistance) because I tried to read the original text [(which may be found here)](https://classics.mit.edu/Aristotle/rhetoric.mb.txt) and struggled over many inverted turns of phrase. This version tries to make accessible the core ideas, while preserving the exact paragraph structure of the original. I hope you find it of use._
